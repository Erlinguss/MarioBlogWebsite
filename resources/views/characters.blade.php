  ...
  <div class="w-full max-w-screen-lg flex flex-col md:flex-row justify-center  md:items-start px-4">
    ...
    <div id="modal1" class="modal">
      <div id="modal-content1" class="modal-content">
        ...
        <p id="modal-text1">The main hero of the Mushroom Kingdom. Mario is always bright and cheerful and instantly recognizable with his blue overalls, red cap, and trademark moustache.
    ...
    <div id="modal2" class="modal">
      <div id="modal-content2" class="modal-content">
        <span class="close">&times;</span>
        <p id="modal-text2">Mario's brother and fellow hero of the Mushroom Kingdom. Luigi is instantly recognizable in his trademark green hat and green shirt.
...
<div id="modal6" class="modal">
  ...
  <p id="modal-text6">
    ...
    Yoshi is kind and carefree. He uses his long tongue to gobble up fruit and enemies, which he can turn into eggs for throwing.</p>
   </div>
  </div>
  ...
  <div id="modal7" class="modal">
    <div id="modal-content7" class="modal-content">
      <span class="close">&times;</span>
    <p id="modal-text7">
      The princess of Sarasaland. Her trademark style includes her yellow dress and flowery accessories.
      Daisy is cheerful, energetic, and a bit of a tomboy. She enjoys playing a variety of sports with Mario and friends.</p>
     </div>
    </div>
...
<div class="character">
  ...
  <div id="modal8" class="modal">
    <div id="modal-content8" class="modal-content">
      <span class="close">&times;</span>
    <p id="modal-text8">
      ...
      Wario and Mario have known each other since they were babies. He's got a boisterous personality and doesn't sweat the small things. He loves garlic and making money.</p>
     </div>
    </div>
...
<div class="character">
  ...
  <div id="modal9" class="modal">
    <div id="modal-content9" class="modal-content">
      <span class="close">&times;</span>
    <p id="modal-text9">
     Wario's pal and accomplice. Waluigi is the self-proclaimed rival of Luigi.
     Waluigi is willing to put in a lot of effort to best Mario and Luigi, if only to annoy them. His long arms and long legs help keep him competitive at sports.</p>
     </div>
    </div>
...
<div class="character">
  ...
  <div id="modal10" class="modal">
    <div id="modal-content10" class="modal-content">
      <span class="close">&times;</span>
    <p id="modal-text10">
      A mysterious lady who travels the galaxy accompanied by her family of star-like creatures called Lumas.
      Rosalina may seem a bit distant, but she is actually quite kind-hearted. She is the adoptive mother of the Lumas. Though her home is among the stars, she'll sometimes joins Mario and friends on their adventures.</p>
    </div>
  </div>
     ...
     <div class="character">
      ...
      <div id="modal11" class="modal">
        <div id="modal-content11" class="modal-content">
          <span class="close">&times;</span>
        <p id="modal-text11">
          ...
          He may throw a tantrum if things don't go his way. He's know to cause plenty of trouble and can be a bit selfish.</p>
         </div>
        </div>
         ...
         <div class="character">
          ...
          <div id="modal12" class="modal">
            <div id="modal-content12" class="modal-content">
              <span class="close">&times;</span>
            <p id="modal-text12">
          Mischievous ghosts who often appear in dark, abandoned places.
          They may be spooky ghosts, but they're also incredibly shy. They will freeze in place and cover their eyes if someone looks right at them.</p>
             </div>
            </div>
            ...
            <div id="modal13" class="modal">
              <div id="modal-content13" class="modal-content">
                <span class="close">&times;</span>
              <p id="modal-text13">
              ...
              <div id="modal14" class="modal">
                <div id="modal-content14" class="modal-content">
                  <span class="close">&times;</span>
                <p id="modal-text14">
                Donkey Kong's trusted friend and partner. His trademarks are his red shirt with yellow stars and red cap.
                Though not as strong as DK, Diddy Kong is agile and a great jumper. He's fast as well, and a great ally for helping DK protect his banana stash.</p>
                 </div>
                </div>
