...
<div id="modal1" class="modal">
  <div id="modal-content1" class="modal-content">
    ...
    <p id="modal-text">The main hero of the Mushroom Kingdom. Mario is always bright and cheerful and instantly recognizable with his blue overalls, red cap, and trademark moustache.
...
<div id="modal2" class="modal">
  <div id="modal-content2" class="modal-content">
    <span class="close">&times;</span>
    <p id="modal-text">Mario's brother and fellow hero of the Mushroom Kingdom. Luigi is instantly recognizable in his trademark green hat and green shirt.
