<head>
    ...
    <script src="{{ asset('js/mario1.js') }}" defer></script>
    ...
    <div id="app">
        ...
        <header class="bg-red-700 py-2 fixed top-0 w-full z-20 ">
            <div class="container mx-auto flex items-center justify-between px-6 flex-col sm:flex-row">
                ...
                <nav class="flex space-x-6 sm:space-x-8 text-white text-base sm:text-lg">
                    @guest
                        <a class="no-underline hover:underline transition duration-300 ease-in-out transform hover:-translate-y-1"
                    ...
                    @else
                        <span
                            class="transition duration-300 ease-in-out transform hover:-translate-y-1">{{ Auth::user()->name }}</span>
                        <a href="{{ route('logout') }}"
        ...
        <header class="bg-gray-900 py-6 fixed top-0 w-full z-30 second-header">
            <div class="container mx-auto flex flex-col items-center justify-center px-6">
                <nav class="flex mt-6">
                    <a class="no-underline text-white hover:underline transition duration-300 ease-in-out transform hover:-translate-y-1 mx-4"
                        href="/"><strong>Home </strong></a>
                    <a class="no-underline text-white hover:underline transition duration-300 ease-in-out transform hover:-translate-y-1 mx-4"
                        href="/blog"> <strong>Blog </strong></a>
                    <a class="no-underline text-white hover:underline transition duration-300 ease-in-out transform hover:-translate-y-1 mx-4"
                        href="{{ route('characters') }}"> <strong>Characters </strong></a>
        </header>
